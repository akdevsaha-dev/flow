...
export default function SignUpPage() {
  return (
    <main className="min-h-screen w-full bg-[#eef3ee] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-neutral-200/50 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-neutral-200/50 rounded-full blur-[100px] pointer-events-none" />
