...
export const NavSidebar = () => {
  ...
  return (
    <div className="md:w-20 w-full md:h-full h-16 flex md:flex-col flex-row items-center py-4 md:py-6 border-r md:border-b-0 border-t md:border-t-0 border-neutral-200/60 bg-[#eef3ee] justify-between z-40 fixed md:relative bottom-0 left-0">
