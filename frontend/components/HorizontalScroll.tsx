  ...
  return (
    <div ref={containerRef} className="overflow-hidden">
      <div className="horizontal flex w-[300vw]">
          ...
          <div className="h-screen  w-full flex-center ">
            <div className="w-6xl bg-[#bfd3c23e] flex h-[80vh] rounded-4xl">
              <div className="flex-1 col-center gap-6">
                {/* Heading */}
                <div className="text-5xl max-w-md  leading-tight text-left">
                ...
                <p className="max-w-sm pl-1 text-lg text-gray-500 leading-relaxed">
              ...
              <div className="flex-1 flex-center w-3xl">
                <Image
                  src={"/friends.svg"}
                  alt="con"
                  height={400}
        ...
        <section className="panel w-[100vw] h-[100vh] shrink-0 bg-neutral-50 flex-center ">
          <div className="h-screen  w-full flex-center ">
            <div className="w-6xl bg-[#bfd3c23e] flex h-[80vh] rounded-4xl">
              <div className="flex-1 col-center gap-6">
                <div className="text-5xl max-w-md  leading-tight text-left">
